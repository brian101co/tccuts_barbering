        ...
        setDateLimits() {
            $.ajax({
                ...
                success: function(data) {
                    $('#date')
                        .attr('min', String(data[0].schedule_start_date))
                        .attr('max', String(data[0].schedule_end_date))
                }
            })
        }
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if ( filtered_bookings_list.length === 0 ) {
                        ...
                        $('.time-slots .card p').click(() => {
                            let step1 = $('.step-1');
                            start = $('.time-slots .card p').data('start');
                            end = $('.time-slots .card p').data('end');
                            step1.fadeOut(() => {
            ...
            $('.step-2').fadeOut(function(){
                ...
                $.ajax({
                    ...
                    success: function(data, status) {
                        $('.thank-you')
                            .empty()
                            .append('<div class="alert alert-success mt-2" role="alert">Thank you! Your\'re reservation has been submitted. You will recieve an email with your appointment details shortly.</div>');
